        ...
        <div className="">
            <div className=" bg-gradient-to-r from-indigo-500 to-cyan-500 flex skew-y-1 relative -top-6">
                ...
                <section className="mx-auto my-44 text-white max-w-screen-md -skew-y-1">
                    ...
                    <span>
                        <button onClick={doScroll} className="bg-navbar90 rounded py-2 px-3 bg-opacity-70 mt-3 mr-2 hover:bg-opacity-80 relative active:top-0.5"><span className="opacity-100 font-bold text-lg">Learn more</span></button>
                        <NavLink to="/connecting">
                            <button className="bg-navbar90 rounded py-2 px-3 bg-opacity-70 mt-3 mr-2 hover:bg-opacity-80 relative active:top-0.5"><span className="opacity-100 font-bold text-lg">Get started <FontAwesomeIcon icon={faArrowRight}/></span></button>
                        </NavLink>
                    </span>
