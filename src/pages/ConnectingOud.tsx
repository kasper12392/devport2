    ...
    return (
        <div className="max-w-screen-lg mx-auto mt-16 text-gray-700 flex">
            ...
            <div className="space-y-12 max-w-screen-md mx-auto">
                ...
                {/*    </svg>*/}
                {/*    /!*<span className="font-medium">Please note:&nbsp;</span><span>ConnectingOud to the API requires a Benefits-Plaza user with a client secret and id. Requesting those can be done <a className="text-sky-600 underline" href="/eyyyyy">here</a>.</span>*!/*/}
                {/*    <span className="font-medium">Please note:&nbsp;</span><span>ConnectingOud to the API requires a Benefits-Plaza user with a client secret and id.</span>*/}
                {/*</div>*/}
